    ...
    <div className="min-h-screen bg-gradient-sand">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        <Card className="shadow-elegant">
          <CardHeader>
            <CardTitle className="text-2xl text-primary">Termos e Condições de Venda</CardTitle>
            <p className="text-muted-foreground">Última atualização: 27 de setembro de 2024</p>
          </CardHeader>
          <CardContent className="space-y-6">
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">1. Informações Gerais</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">2. Produtos e Disponibilidade</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">3. Encomendas e Pagamentos</h2>
              <p className="text-foreground leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">4. Entrega</h2>
              <p className="text-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">5. Qualidade e Frescura</h2>
              <p className="text-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">6. Devoluções e Reembolsos</h2>
              <p className="text-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-3">7. Contacto</h2>
              <p className="text-foreground leading-relaxed">
